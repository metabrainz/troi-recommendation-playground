...
class TestParser(unittest.TestCase):
    ...
    def test_compound(self):
        r, _ = parse(
            'artist:05319f96-e409-4199-b94f-3cabe7cc188a #downtempo tag:("trip hop" abstract):or c:d1ad6d63-448b-43c7-9de3-e60ac8418106 y:1996 ys:1986-2000'
        )
        assert r[0] == {"entity": "artist", "values": ["05319f96-e409-4199-b94f-3cabe7cc188a"], "args": None}
        assert r[1] == {"entity": "tag", "values": ["downtempo"], "args": None}
        assert r[2] == {"entity": "tag", "values": ["trip hop", "abstract"], "args": "or"}
        assert r[3] == {"entity": "country", "values": ["d1ad6d63-448b-43c7-9de3-e60ac8418106"], "args": None}
        assert r[4] == {"entity": "year", "values": [1996], "args": None}
        assert r[5] == {"entity": "years", "values": [1986, 2000], "args": None}
